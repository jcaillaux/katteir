...
/// Largest clip file the app will read.
...
/// Largest config file the app will read.
pub const MAX_CONFIG_BYTES: usize = 64 * 1024;

/// Largest D-Bus message the app sends or reads (the spec allows 128 MiB).
