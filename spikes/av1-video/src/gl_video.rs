...
impl GlVideo {
    pub fn new(gl: glow::Context, stacked_width_px: u32, stacked_height_px: u32) -> Result<Self, String> {
        ...
        unsafe {
            ...
            for (unit, name) in ["y_plane", "u_plane", "v_plane"].iter().enumerate() {
    ...
    /// The GL function table, for readback checks in the same context.
    ...
    pub fn draw_frame(&mut self, picture: &dav1d::Picture) -> slint::Image {
        ...
        unsafe {
            ...
            gl.viewport(0, 0, self.stacked_width_px as i32, colour_height_px as i32);
