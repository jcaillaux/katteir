//! Control for spikes/slint-size: the same window and readback code, built
//! against unpatched Slint. Usage: snapshot_probe [run_secs] [snapshot.pam]
...
const LABEL: &str = "size probe: unpatched Slint — Latin, العربية, 日本語, ไทย";
